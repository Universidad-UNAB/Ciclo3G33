...
function loadTable() {
    $.ajax({
        url: 'http://129.213.131.28:8080/security/person',
        method: "GET",
        headers: {
...
function findById(id) {
    $.ajax({
        url: 'http://129.213.131.28:8080/security/person/' + id,
        method: "GET",
        headers: {
            "Content-Type": "application/json"
        }
...
function Modificar(){    
    $.ajax({
        url: 'http://129.213.131.28:8080/security/person/'+parseInt($("#id").val()),
        data: JSON.stringify({
            tipoDocumento: $("#tipoDocumento").val(),
            documento: $("#documento").val(),
            primerNombre: $("#primerNombre").val(),
